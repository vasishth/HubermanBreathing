...
# Claims that I investigated

## Claim summarized in Figure 2
...
# My data analysis of claim in Figure 3
...
Subset the data of the people who completed the key task:
...
Here are the plot using only those data in which subjects actually did the task:
...
What about if we add comletion as a predictor:
...
But there is no significant increase in positive affect with breathing vs MM. This is what is claimed in the paper. Numerically, actually, there is a *decrease* in positive affect change due to breathing.
